...
export const PROP_SCHEMAS: Record<BackdropId, ReadonlyArray<PropControl>> = {
  ...
  'midnight-meteor': [
    {
      ...
      key: 'sky',
      label: 'sky',
      hint: 'background gradient + nebula palette',
      default: 'midnight',
      options: [
        { value: 'midnight', label: 'midnight' },
    ...
    },
    {
      ...
      key: 'starDensity',
      label: 'starDensity',
      hint: 'star-count multiplier (clamped against canvas area)',
      min: 0.2,
      max: 2,
      step: 0.05,
      default: 1,
    },
    {
      ...
      key: 'meteorRate',
      label: 'meteorRate',
      hint: 'meteor spawn-rate multiplier — 0 disables new meteors',
      min: 0,
      max: 3,
      step: 0.1,
      default: 1,
  ...
  'tidal-drift': [
    ...
    },
    {
      ...
      key: 'waveSpeed',
      label: 'waveSpeed',
      hint: 'wave animation speed multiplier',
      min: 0,
      max: 3,
      step: 0.05,
      default: 1,
    },
    {
      ...
      key: 'cloudOpacity',
      label: 'cloudOpacity',
      hint: 'cloud opacity multiplier — 0 hides them',
      min: 0,
      max: 1.5,
      step: 0.05,
      default: 1,
  ...
  'wire-mesa': [
    {
      ...
      key: 'palette',
      label: 'palette',
      hint: 'grid + horizon glow color preset',
      default: 'cyan',
      options: [
    ...
    },
    {
      ...
      key: 'scrollSpeed',
      label: 'scrollSpeed',
      hint: 'terrain scroll-speed multiplier',
      min: 0,
      max: 3,
      step: 0.05,
      default: 1,
    },
    {
      ...
      key: 'terrainHeight',
      label: 'terrainHeight',
      hint: 'vertical amplitude of the mountains',
      min: 0.2,
      max: 2,
      step: 0.05,
      default: 1,
    },
    {
      ...
      key: 'fogDistance',
      label: 'fogDistance',
      hint: 'how far fog reaches — lower = closer horizon',
      min: 0.5,
      max: 2,
      step: 0.05,
      default: 1,
    },
    {
      ...
      key: 'cameraBob',
      label: 'cameraBob',
      hint: 'subtle vertical bob of the camera',
      default: true,
    },
  ],
  ...
  'flow-field': [
    ...
    },
    {
      ...
      key: 'particleCount',
      label: 'particleCount',
      hint: 'total particles in the field',
      min: 200,
      max: 5000,
      step: 100,
      default: 2400,
    },
    {
      ...
      key: 'speed',
      label: 'speed',
      hint: 'particle speed multiplier',
      min: 0,
      max: 3,
      step: 0.05,
      default: 1,
    ...
    },
    {
      ...
      key: 'lineWidth',
      label: 'lineWidth',
      hint: 'stroke width in CSS pixels',
      min: 0.5,
      max: 3,
      step: 0.05,
      default: 1.05,
